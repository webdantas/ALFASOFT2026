...
9. Insira as credenciais para poder editar pessoas:
	```bash
...
- Crie um usuário ou use o seeder para acessar as áreas protegidas.

## Scripts úteis
- `php artisan migrate:fresh --seed` — recria o banco e popula com dados de exemplo.
- `npm run dev` — inicia o watcher do frontend.
...
## Contato
Dúvidas ou sugestões: webdantas@gmail.com
